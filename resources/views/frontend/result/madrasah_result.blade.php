                        ...
                        <table class="table table-striped table-bordered" id="myTable" style="margin-bottom:0px;"
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>দাখিল নির্বাচনী ফলাফল ২০২৩</td>
                                    <td align="center">
                                        <a href="storage/uploads/result/2023-10-26_6539fa053c563.pdf" target="_blank"
                                            class="btn btn-xs btn-success">দেখুন</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">২</td>
                                    <td>আলিম ১ম বর্ষ বার্ষিক ফলাফল ২৩</td>
                                    <td align="center">
                                        <a href="storage/uploads/result/2023-09-14_650301f90f2cd.pdf" target="_blank"
                                            class="btn btn-xs btn-success">দেখুন</a>
                                    </td>
                                </tr>
                            </tbody>
